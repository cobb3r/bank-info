<main class="row d-flex align-items-center justify-content-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-4 p-3 text-center">
                <h1>Delete Account</h1>
                <hr>
                <form id="form" class="d-flex align-items-center justify-content-center flex-column p-1" action="/project-root/public/delete" method="post">
